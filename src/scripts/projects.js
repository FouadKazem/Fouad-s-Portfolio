...
const common = [
    ...
    [document.querySelector('.project>img'), 'src', imgs.fouadsPortfolio]
]
const commonLight = [
    ...
    ['.project', 'border', '0.25rem solid rgb(55, 55, 55)'],
    ['.project', 'background-color', 'white'],
    ['.project>*', 'color', 'rgb(55, 55, 55)'],
    ['.project>img', 'border', '0.25rem solid rgb(55, 55, 55)'],
...
const commonDark = [
    ...
    ['.project', 'border', '0.25rem solid rgb(150, 150, 150)'],
    ['.project', 'background-color', 'rgb(55, 55, 55)'],
    ['.project>*', 'color', 'white'],
    ['.project>img', 'border', '0.25rem solid rgb(150, 150, 150)'],
